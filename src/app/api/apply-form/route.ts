...
export async function POST(req: NextRequest) {
  try {
    ...
    <table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width:100%;">
      ...
      <tr><th align="left">Building Matter</th><td>${parsed.data.buildingMatter}</td></tr>
      <tr><th align="left">Jargon</th><td>${parsed.data.jargon}</td></tr>
      ...
      <tr><th align="left">Product</th><td>${parsed.data.whatsProduct || "-"}</td></tr>
      <tr><th align="left">Quantum Options</th><td>${parsed.data.quantumOptions.join(
        ", "
      )}</td></tr>
      <tr><th align="left">Relate AI</th><td>${parsed.data.relateAI || "-"}</td></tr>
      <tr><th align="left">AI Options</th><td>${parsed.data.aiOptions.join(", ")}</td></tr>
      <tr><th align="left">Decentralized</th><td>${parsed.data.decentralized || "-"}</td></tr>
      ...
      <tr><th align="left">Startup Embody</th><td>${parsed.data.startupEmbody}</td></tr>

      <!-- Vision, Readiness, & Fit -->
      <tr><th colspan="2" align="left" style="background:#f3f3f3;">Vision, Readiness & Fit</th></tr>
      <tr><th align="left">Join DeQUIP</th><td>${parsed.data.joinDequip}</td></tr>
      <tr><th align="left">Blocker</th><td>${parsed.data.whatsYourBlocker}</td></tr>
      <tr><th align="left">Mentorship</th><td>${parsed.data.mentorshipKind.join(", ")}</td></tr>
      <tr><th align="left">Raise Funds</th><td>${parsed.data.raiseFunds}</td></tr>
      <tr><th align="left">Stage</th><td>${parsed.data.atWhatStage}</td></tr>

      <!-- Bonus Round -->
      <tr><th colspan="2" align="left" style="background:#f3f3f3;">Bonus Round</th></tr>
      <tr><th align="left">Launched Before</th><td>${parsed.data.launchedbefor}</td></tr>
      <tr><th align="left">Project URLs</th><td>${parsed.data.projectUrls
        .map((p) => p.url)
        .join("<br/>")}</td></tr>
