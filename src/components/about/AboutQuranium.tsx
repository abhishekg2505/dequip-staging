    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-p2 font-open-sans mt-[15px] mb-[20px]">
          ...
          and seamless developer access to power the next wave of decentralized innovation. With its{" "}
          <strong>
            quantum-secure core, AI-native blockchain infrastructure, and QSafe Wallet - supporting
            over 70 networks
          </strong>{" "}
        ...
        <p className="text-p2 font-open-sans mb-[20px]">
          ...
          alliance, 100+ AI-powered games, and over 20,000 daily transactions, with global traction
          across 50+ countries. Quranium is proud to collaborate with over 40 leading media partners
      ...
      <div ref={cardsRef} className="flex flex-col mt-10 md:mt-0 relative w-full">
        ...
        <div className="max-w-[585px] mb-5  p-[20px_20px_40px] border border-[#1E1F23] bg-[url('/images/about/wire5.png')] bg-right-top bg-size-[223px_auto] bg-no-repeat rounded-[10px]">
          ...
          <div className="flex flex-row gap-x-2 mt-1.5">
            <Image src="/images/about/star.svg" alt="star" width={10} height={10} />
            <p className="text-p2 text-[#D4D4D4] font-open-sans">Token allocations as incentives</p>
          </div>
        </div>
      </div>
    </div>
