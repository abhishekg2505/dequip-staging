        ...
        <div ref={mainTitleRef} className="relative z-10">
          <div className="w-full mb-5  p-[20px_20px_40px] border border-[#1E1F23] bg-[url('/images/homepage/tl1.png')] bg-right-bottom bg-size-[223px_auto] bg-no-repeat rounded-[10px]">
            <p ref={mainTitleRef} className="text-left text-p3 font-open-sans font-normal">
              Once you hit submit, your application goes directly to our selection committee,
              composed of Quranium leadership, ecosystem partners, and venture allies. <br />
              Expect to hear from us in 2-3 weeks. If shortlisted, you&rsquo;ll be invited for a
              15-minute live interview with our core team.
            </p>
            <p
              ref={headingRef}
              className="text-left text-p3 font-open-sans font-normal italic mt-5 mb-10"
            >
              Don&rsquo;t forget to check out QNet Access if you want to join the ecosystem even if
              you&rsquo;re not selected.
            </p>
...
export default ApplyMessageBox;
