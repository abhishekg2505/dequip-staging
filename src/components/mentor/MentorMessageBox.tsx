        ...
        <div ref={mainTitleRef} className="relative z-10">
          <div className="w-full mb-5  p-[20px_20px_40px] border border-[#1E1F23] bg-[url('/images/homepage/tl1.png')] bg-right-bottom bg-size-[223px_auto] bg-no-repeat rounded-[10px]">
            <p ref={mainTitleRef} className="text-left text-p3 font-open-sans font-normal">
              Once you submit, our team will review your application and be in touch with next
              steps. Thanks for your interest in being part of building a more secure, visionary
              future.
            </p>
            <p
              ref={headingRef}
            ...
            >
              Want to stay ahead of the next cycle?{" "}
              <Link ref={heading2Ref} href="#" className="font-bold">
                Subscribe to Pulse
              </Link>{" "}
